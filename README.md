...
**235 unit tests passing** — backend (C++): database, domain entities, API router, CSV import, HL7, FHIR, statistics, utils.
...
**Current version: [1.0.0](CHANGELOG.md#100)** — God-file decomposition, full test pyramid (backend + frontend + E2E), governance + security hardening; 235 tests passing.
