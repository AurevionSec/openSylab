...
void registerCsvImportTests() {
    ...
    registerTest("CsvImport::ImportWithMissingFields", test_csvimport_ImportWithMissingFields);
    registerTest("CsvImport::ImportWithEmptyId", test_csvimport_ImportWithEmptyId);
    registerTest("CsvImport::ImportWithWhitespaceId", test_csvimport_ImportWithWhitespaceId);
    registerTest("CsvImport::ImportMixedValidAndInvalid", test_csvimport_ImportMixedValidAndInvalid);
    registerTest("CsvImport::ImportEmptyFile", test_csvimport_ImportEmptyFile);
    registerTest("CsvImport::ImportQuotedFields", test_csvimport_ImportQuotedFields);
    registerTest("CsvImport::ImportMultilineFields", test_csvimport_ImportMultilineFields);
    registerTest("CsvImport::ImportUnclosedQuotes", test_csvimport_ImportUnclosedQuotes);
}
