 ...
 * @brief Einfacher Test-Runner für OpenSylab v0.1
 *
 * Dieser Test-Runner läuft alle Unit-Tests und gibt das Ergebnis aus.
 * Für v0.1 verwenden wir ein minimalistisches Test-Framework ohne externe Abhängigkeiten.
 */
...
int main() {
    std::cout << "\n";
    std::cout << "╔═══════════════════════════════════════════════════════════╗\n";
    std::cout << "║          OpenSylab v0.1 - Unit Test Suite                 ║\n";
    std::cout << "╚═══════════════════════════════════════════════════════════╝\n";
    std::cout << "\n";
