/**
 * @file main.cpp
 * @brief Haupteinstiegspunkt für OpenSylab LIMS v0.1
 *
 * OpenSylab - Open Source Laboratory Information Management System
 * Version 0.1.1
 *
 * Dieses Programm bietet grundlegende LIMS-Funktionalität für kleine
...
int main(int argc, char* argv[]) {
    std::cout << "OpenSylab v0.1.1 wird gestartet...\n" << std::endl;
    ...
    try {
        ...
        std::cerr << "FEHLER: Unerwarteter Fehler im CLI: " << e.what() << std::endl;
        database->close();
        return 1;
    }
